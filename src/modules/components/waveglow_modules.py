# A lot of this is copied from npuichigo/waveglow
# For now, I don't claim authorship, but I should go back over this sometime.
...
# I need to double check this to make sure it works,
# plus, I don't think this is idiomatic
...
class UpsampleNet(nn.Module):
    ...
    def forward(self, input):
        ...
        output = self.squeeze_layer(output)[0] # type: ignore
        return output